	...
	return (
		<section className="hero" {...useBlockProps()}>
			...
			<RichText
				...
				onChange={(newTitle) => setAttributes({ headline: newTitle })}
			...
			<RichText
				...
				placeholder={__('This is the most important supporting point on the page.')}
			/>
			<a href={attributes.urlPrimary} className='hero-navigation-primary'>{attributes.ctaPrimary}</a>
			...
			/>
			<a href={attributes.urlSecondary} className='hero-navigation-secondary'>{attributes.ctaSecondary}</a>
			<LinkInput
